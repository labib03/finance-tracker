...
export default function NumericInput({
    ...
    const calculatorUI = (
        <div className={cn("flex flex-col bg-white", isDesktop ? "min-h-[420px]" : "h-[85dvh] sm:h-[80dvh]")}>
            ...
            {/* Final Action */}
            <div className={cn("grid grid-cols-3 gap-3 px-6 bg-white shrink-0", isDesktop ? "pb-6 pt-0" : "pt-2 pb-[calc(env(safe-area-inset-bottom)+24px)]")}>
                <Button 
                    type="button"
                    variant="outline"
