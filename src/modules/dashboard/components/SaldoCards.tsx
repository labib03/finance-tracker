                ...
                {saldoAkun.map((akun) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 p-6 sm:p-8 pb-3 sm:pb-4 relative z-10">
                            ...
                            <CardContent className="p-6 sm:p-8 pt-0 relative z-10 w-full overflow-hidden">
                                <p className="text-xs font-black uppercase tracking-widest text-muted-foreground/80 mb-1 italic">Tersedia</p>
                                <p className="text-2xl font-black tracking-widest text-foreground display-number group-hover:scale-105 transition-transform origin-left duration-500 truncate w-full">
